...
func doSomething(ctx context.Context) {
	...
	// automatically cancel the context 1500 milliseconds (1.5 seconds) after a certain amount of time has elapsed
	// Using these functions, you’ll be able to ensure your programs don’t consume more resources than needed on your computers.
	// Understanding the errors they cause contexts to return will also make troubleshooting errors in your own and other Go programs easier
